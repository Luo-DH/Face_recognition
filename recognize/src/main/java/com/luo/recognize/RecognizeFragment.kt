...
//import com.luo.base.face.others.toCropBitmap
//import com.luo.base.face.others.toGetLandmarks
//import com.luo.base.face.others.toRotaBitmap
...
//        val repository = MainRepository()
//        val viewModelFactory = MainViewModelFactory(repository, this.requireContext())
...
//        cameraProviderFuture = ProcessCameraProvider.getInstance(this.requireContext()).apply {
...
//                    this@RecognizeFragment,
//                    cameraSelector,
//                    preview,
//                    imageAnalysis
//                )
//
//            }, ContextCompat.getMainExecutor(this@RecognizeFragment.requireContext()))
//        }
//    }
//
//    /**
...
//
//        // 人脸检测获得数据
//        viewModel.detectBox2.observe(viewLifecycleOwner) {
